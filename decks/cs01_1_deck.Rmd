...
You will visualize data on birth weight and gestational age at delivery for babies born in North Carolina from 2011-2017. The source of these data is the North Carolina State Center for Health Statistics. Relevant variables include the following.
...
Vital records data can be messy, as research-quality data cleaning schemes are typically not used.  Sophisticated schemes have been developed to eliminate infeasible values for birth weight (generally babies born $<500$g do not survive), gestational age (virtually no babies born before 21 weeks survive), and their combination (e.g., a 41 week 600g baby is exceedingly unlikely). 
